            ...
            success(res_orderGET) {
              ...
              if (res_orderGET.data) {
                ...
                wx.request({
                  ...
                  success(res_menuGET) {
                    console.log(res_menuGET.data, 'res_menuGET')
                    if (res_menuGET.data) {
                      let breakfast = new Set();
                      let lunch = new Set();
                      let dinner = new Set();

                      // breakfast.add({'menuList': '整体评价'})
                      ...
                      // 早午晚餐整体评价
                      rateList[0].list.unshift({_id: 0, className: "主食", name: "早餐评价", imgSrc: "Dishesphoto/kaozaogao.png", isInside: true, isSpecial: false, isStorage: true, rate: 0, createdTime: new Date(), usedTime: new Date()});
                      rateList[1].list.unshift({_id: 1, className: "主食", name: "午餐评价", imgSrc: "Dishesphoto/suanxianghuotui.png", isInside: true, isSpecial: false, isStorage: true, rate: 0, createdTime: new Date(), usedTime: new Date()});
                      rateList[2].list.unshift({_id: 2, className: "主食", name: "晚餐评价", imgSrc: "Dishesphoto/dish.png", isInside: true, isSpecial: false, isStorage: true, rate: 0, createdTime: new Date(), usedTime: new Date()});
